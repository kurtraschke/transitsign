...
cabiTemplate.main = function(opt_data, opt_sb) {
  ...
  for (var stationIndex18 = 0; stationIndex18 < stationListLen18; stationIndex18++) {
    ...
    output.append('<div class="cabistation"><div class="stationtitle">', soy.$$escapeHtml(stationData18.name), '</div>', (stationData18.installed == 'true' && stationData18.locked == 'false') ? 'Bikes available: ' + soy.$$escapeHtml(stationData18.nbBikes) + '<br>Docks available: ' + soy.$$escapeHtml(stationData18.nbEmptyDocks) : 'Station unavailable.', '</div>');
  }
