var metrorail = {
    ...
    doInit: function(div, socket) {
        ...
        var newsize, dh, oneRow, empx, estCrawlHeight, availableSpace, error, numTrains;
        ...
        availableSpace = ($(window).height()-$('#header').outerHeight()-$('#railpredictions').outerHeight()+oneRow-estCrawlHeight);
        ...
        var setIncidents = function (response) {
            ...
            if (response.incidents.length === 0) {
                ...
                $('#incidents').append(metrorail.incidents({'incidents': response.incidents}));
            }
